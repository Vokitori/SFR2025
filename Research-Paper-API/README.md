...
5. ./kafka-configs.sh --bootstrap-server broker-1:19092,broker-2:19092,broker-3:19092 --entity-type topics --entity-name research-paper --alter --add-config min.insync.replicas=3
